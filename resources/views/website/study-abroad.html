...
<head>
    ...
    <link rel="icon" href="images/logo/logo.jpg" type="image/x-icon"><!-- Stylesheets-->
...
<body>
                                    ...
                                    <div class="range range-10 range-md-center range-md-middle range-lg-around">
                                        <div class="cell-md-3">
                                            <div class="unit unit-horizontal unit-top unit-spacing-xs">
                                                <div class="unit-left">
                                                    <span class="icon novi-icon mdi mdi-phone text-middle"
                                                        style="color: #2c3591"></span>
                                                </div>
                                                <div class="unit-body">
                                                    <a class="reveal-block" href="tel:#">+977-9851026668,</a><a
                                                        href="tel:#">+977-9815356075,</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="cell-md-3 text-center">
                                            <div class="rd-navbar-brand">
                                                <a class="reveal-inline-block" href="index.html"><img src="images/logo/logo.jpg"
                                                        alt="" width="191" height="80" /></a>
                                            </div>
                                        </div>
                                        <div class="cell-md-4">
                                        ...
                                        <form class="rd-navbar-search-form search-form-icon-right rd-search"
                                            ...
                                            <div class="form-group">
                                                <label class="form-label"
                                                    for="rd-navbar-mobile-search-form-control">Search...</label><input
                                                    class="rd-navbar-search-form-control form-control form-control-gray-lightest"
                                                    id="rd-navbar-mobile-search-form-control" type="text" name="s"
                                                    autocomplete="off" />
                                            </div>
            ...
            <div class="shell-wide">
                <div class="range range-50 range-xs-center range-xl-left">
                    ...
                    <div class="cell-sm-6 cell-md-5 cell-xl-3">
                        <article class="post-event">
                            <div class="post-event-img-overlay"><img class="img-responsive"
                                    src="https://images.pexels.com/photos/1202723/pexels-photo-1202723.jpeg?auto=compress&cs=tinysrgb&w=1600"
                                    alt="" width="420" height="420">
                            </div>
                            <div class="unit unit-lg unit-lg-horizontal">
                                <div class="unit-body">
                                    <div class="post-event-body text-lg-left">
                                        <h6><a href="abroad-study-country.html">USA</a></h6>
                    ...
                    <div class="cell-sm-6 cell-md-5 cell-xl-3">
                        <article class="post-event">
                            <div class="post-event-img-overlay"><img class="img-responsive"
                                    src="https://images.pexels.com/photos/3744699/pexels-photo-3744699.jpeg?auto=compress&cs=tinysrgb&w=1600"
                                    alt="" width="420" height="420">
                            </div>
                            <div class="unit unit-lg unit-lg-horizontal">
                                <div class="unit-body">
                                    <div class="post-event-body text-lg-left">
                                        <h6><a href="abroad-study-country.html">Canada</a></h6>
                    ...
                    <div class="cell-sm-6 cell-md-5 cell-xl-3">
                        <article class="post-event">
                            <div class="post-event-img-overlay"><img class="img-responsive"
                                    src="https://images.pexels.com/photos/7362558/pexels-photo-7362558.jpeg?auto=compress&cs=tinysrgb&w=1600"
                                    alt="" width="420" height="420">
                            </div>
                            <div class="unit unit-lg unit-lg-horizontal">
                                <div class="unit-body">
                                    <div class="post-event-body text-lg-left">
                                        <h6><a href="abroad-study-country.html">Switzerland</a></h6>
                    ...
                    <div class="cell-sm-6 cell-md-5 cell-xl-3">
                        <article class="post-event">
                            <div class="post-event-img-overlay"><img class="img-responsive"
                                    src="https://media.istockphoto.com/photos/chinese-flag-picture-id452606475?b=1&k=20&m=452606475&s=612x612&w=0&h=nhZ1p1PjKsTyS9Eo-M1q5FG_74N7w3QNdHJ6O0xn08w="
                                    alt="" width="420" height="420">
                            </div>
                            <div class="unit unit-lg unit-lg-horizontal">
                                <div class="unit-body">
                                    <div class="post-event-body text-lg-left">
                                        <h6><a href="abroad-study-country.html">China</a></h6>
                        ...
                        <div class="cell-md-3 cell-lg-3">
                            ...
                            <div class="offset-top-30 text-center">
                                <ul class="list-inline list-inline-xs list-inline-madison">
                                    <li>
                                        <a class="icon novi-icon icon-xxs fa-facebook icon-circle icon-gray-light-filled"
                                            href="#"></a>
                                    </li>
                                    <li>
                                        <a class="icon novi-icon icon-xxs fa-twitter icon-circle icon-gray-light-filled"
                                            href="#"></a>
                                    </li>
                                ...
                                <ul class="list-unstyled contact-info list">
                                    <li>
                                        <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                                            <div class="unit-left">
                                                <span
                                                    class="icon novi-icon mdi mdi-phone text-middle icon-xs text-madison"></span>
                                            </div>
                                            <div class="unit-body">
                                    ...
                                    <li>
                                        <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                                            <div class="unit-left">
                                                <span
                                                    class="icon novi-icon mdi mdi-email-open text-middle icon-xs text-madison"></span>
                                            </div>
                                            <div class="unit-body">
                                ...
                                <form class="rd-mailform form-subscribe" data-form-output="form-output-global"
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            <label class="form-label" for="form-email">Your e-mail</label><input
                                                class="form-control" id="form-email" type="email" name="email"
                                                data-constraints="@Required @Email" /><span class="input-group-btn"><button
            ...
            <div class="section-5 bg-madison context-dark novi-background">
                <div class="shell text-md-left">
                    <p class="">
                        ...
                        Terms of Use and <a href="privacy.html">Privacy Policy.</a><span> Design&nbsp;by Radiant
                            InfoTech
                            Nepal</span>
                    </p>
                </div>
    ...
    <div class="snackbars" id="form-output-global"></div><a class="builder-button"
        href="http://whizthemes.com/builder/b_patshala/patshala-builder" target="_blank"><img
            src="images/novi-icon-26x26.png" alt="" width="26" height="26">Try builder</a>
